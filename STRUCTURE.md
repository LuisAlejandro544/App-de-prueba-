...
│   │   │   ├── java/com/example/
│   │   │   │   ├── MainActivity.kt      # Activity principal con Surface, Edge-to-Edge y enrutamiento
│   │   │   │   ├── audio/               # Servicios de audio, video y bridges
...
│   │   │   │   ├── ui/
│   │   │   │   │   ├── MainHubScreen.kt         # Menú principal y catálogo de herramientas de audio
...
│   │   │   │   │       └── Type.kt
│   │   │   │   └── viewmodel/
│   │   │   │       ├── AudioConverterViewModel.kt # Lógica de negocio de convertidor
│   │   │   │       └── VideoToAudioViewModel.kt   # Lógica de negocio de extracción de video
│   │   │   └── res/                     # Recursos Android (strings, drawables, ic_launcher)
...
├── STRUCTURE.md                         # Este archivo con el árbol de componentes
